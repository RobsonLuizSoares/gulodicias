...
const schema = yup.object().shape({
    ...
    cpf: yup.string().required('Por favor, inclua número de cpf válido(somente números)'),
    phone: yup.string().required('Favor preencher seu telefone, somente números'),
...
const Cart = () => {
    ...
    const empty = Object.keys(cart.cart).length < 1
    ...
    return (
        <div>
            ...
            <Header />
            {data && data.status === 'Pago com PIX' && <Thanks />}
            {(!data || data.status !== 'Pago com PIX') && (
                <div className='container mx-auto font-body font-normal pt-48'>
                    {empty ? <Empty /> :
                                    ...
                                    <table className="w-full text-sm lg:text-base" cellSpacing="0">
                                        <thead>
                                            <tr className="h-12 uppercase">
                                                ...
                                                <th className="text-left font-body">Gulodícia</th>
                                                <th className="lg:text-right text-left pl-5 lg:pl-0">
                                                    <span className="lg:hidden" title="Quantity">Qtd</span>
                                                    <span className="hidden lg:inline font-body">Quantidade</span>
                                                </th>
                                                <th className="hidden text-right md:table-cell font-body">Preço Unitário</th>
                                                <th className="text-right font-body">Preço Total </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <div className="justify-center md:flex md:flex-col ">
                                                    {orderStatus === 'pre-order' && (<form onSubmit={form.handleSubmit}>
                                                        ...
                                                        <div className="flex flex-col items-center w-full h-13 mb-12 pl-3 ">
                                                            <div className='flex'>
                                                                {form.errors && form.errors.name && <p className='font-semibold text-red-400'>{form.errors.name}</p>}
                                                            </div>
                                                            ...
                                                            <div className='flex'>
                                                                {form.errors && form.errors.cpf && <p className='font-semibold text-red-400'>{form.errors.cpf}</p>}
                                                            </div>
                                                            <div className='my-1 w-full flex flex-row'>
                                                            ...
                                                            <div className='flex'>
                                                                {form.errors && form.errors.phone && <p className='font-semibold text-red-400'>{form.errors.phone}</p>}
                                                            </div>
                                                            <div className='my-1 w-full flex flex-row'>
